...
Koruza: V kodi **kazalniki_izracuni_in_izrisi.R** se opravijo vsi izračuni in izrisi rezultatov, ki vključujejo naslednje izhodne datoteke:
...
- grafi časovnih potekov z ovojnicami za pšenico (slike v mapi **časovni_poteki**)
